...
export const BlogCard: React.FC<BlogCardProps> = ({
    ...
    return (
        <div className="sm:w-[358px] md:w-[460px] md:p-0 p-[16px]">
            ...
            <h1 className="text-[20px] font-[700] leading-[28px]">{title}</h1>
            {chapters !== 0 && (
            ...
            <p
                className={`text-[16px] font-[400] text-wrap leading-[24px] pb-[16px] ${
                    !chapters && "pt-[24px]"
                }`}
            >
                {description}
            ...
            <Link
                href={btn_link}
                className=" text-[#3f83f8] text-[16px] leading-[24px] font-[500]"
            >
                {btn_text}
            </Link>
        </div>
