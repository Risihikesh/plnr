  ...
  pricing: [
    {
      ...
      features: [
        ...
        },
        {
          title: "Timelines",
          description:
            "We deliver the financial plan in 10–15 days and the mode of delivery would be online. The consolation is for 1 year."
        }
      ],
    ...
    },
    {
      ...
      features: [
        {
          title: "Plan Review",
          description: "We review if you have implemented the previous year plan."
        },
        {
          title: "Investment Review",
          description:
            "Review of the suggested investments if you are on the right track."
        },
        {
          title: "Goal Adjustment",
          description:
            "If there are any changes in goals, we recreate the plan as per goals."
        },
        {
          title: "Continuous Support",
          description: "We provide ongoing support for 1 year."
        }
      ],
      buttonText: "Free Call"
    }
