...
const Detail = () => {
  return (
      <div className="flex flex-col justify-center items-center m-10 gap-y-10">
          ...
          <div className="bg-[#F8FBFF] min-h-[100vh] flex flex-col p-[8px] py-4 md:p-4 w-full items-center gap-y-[12px] md:gap-y-8 shadow-md">
              <p>HDFC LIFE</p>
              ...
              <p className="text-left md:text-center text-base leading-[24px] md:text-[20px] md:leading-[41.04px] text-[#3B414D] md:text-[#13171F] font-normal md:font-medium">
